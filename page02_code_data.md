...
{% for ds in fig.req %}
{% if ds.storage == 'local' %}
<b class="post-text"><a style="font-size: 0.9em;" href="{{site.url}}/{{site.baseurl}}/datasets/{{ds.link}}">{{ds.title}}</a></b>
{% else %}
<b class="post-text"><a style="font-size: 0.9em;" href="{{ds.link}}" >{{ds.title}}</a></b>
{% endif %}
<br/>
{% endfor %}
</div>
